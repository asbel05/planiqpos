...
final class MarcaCell: UITableViewCell {
    
    static let identifier = "MarcaCell"
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            nombreLabel.topAnchor.constraint(equalTo: containerView.topAnchor, constant: 14),
            nombreLabel.leadingAnchor.constraint(equalTo: iconContainer.trailingAnchor, constant: 12),
            nombreLabel.trailingAnchor.constraint(lessThanOrEqualTo: estadoBadge.leadingAnchor, constant: -8),
            ...
            productosCountLabel.bottomAnchor.constraint(equalTo: containerView.bottomAnchor, constant: -14),
    ...
    func configure(with marca: Marca) {
        nombreLabel.text = marca.nombre
        productosCountLabel.text = "\(marca.productosCount) productos"
